...
let!(:first_match) { Gameplayer.create(team: "black", user_id: first_user.id, game_id: first_game.id )}
  ...
  #     sign_in first_user
  #
  #     put :update, params: {id: first_game.id, coordinates: [2, 1, 3, 2]}
  #
  #     expect(response).to redirect_to(first_game)
  #     expect(first_game.reload.state_of_piece[3][4]).to eq "B"
  #   end
  #   it "fail to update" do
  #     sign_in first_user
  #     put :update, params: {id: first_game.id, coordinate: [1, 0, 2, 2]}
  #
  ...
  #       sign_in first_user
  #       put :update, params: {id: second_game.id, coordinate: [3,2, 4,1]}
  #
  ...
  #       sign_in first_user
  #       put :update, params: {id: third_game.id, coordinate: [3, 2, 5, 4]}
  #
  ...
  #       sign_in first_user
  #       put :update, params: {id: third_game.id, coordinate: [4, 3, 2, 5]}
  #
  #       expect(response).to redirect_to(third_game)
  ...
  #       sign_in first_user
  #       put :update, params: {id: third_game.id, coordinate: [4, 3, 3, 2]}
  #
  #       expect(response).to redirect_to(third_game)
  #       expect(third_game.reload.state_of_piece[4][3]).to eq nil
  ...
  #       sign_in first_user
  #       put :update, params: {id: third_game.id, coordinate: [4, 3, 2, 1]}
  #       # expect(response).to redirect_to(third_game)
  #
  ...
  #       expect(third_game.reload.state_of_piece[3][2]).to eq nil
  #
  #       put :update, params: {id: third_game.id, coordinate: [2, 1, 0, 3]}
  #
  #       expect(response).to redirect_to(third_game)
  ...
  #       sign_in first_user
  #       put :update, params: {id: third_game.id, coordinate: [1, 4, 0, 3]}
  #
  #       expect(response).to redirect_to(third_game)
  ...
  #       sign_in first_user
  #       put :update, params: {id: third_game.id, coordinate: [0, 3, 1, 4]}
  #
  #       expect(response).to redirect_to(third_game)
